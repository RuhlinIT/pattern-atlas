...
export const angular: PatternLanguageExample = {
  ...
  explanation: "Caching and metrics remain independent wrapper layers around the same HttpClient contract, so Angular code can compose or remove them without changing callers.",
};
